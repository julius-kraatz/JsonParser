...
namespace JsonTests
{
    ...
    public class JsonTests
    {
        ...
        [TestMethod]
        [ExpectedException(typeof(JsonParserMemberNameNotFoundException))]
        ...
        public void LexerReturnsExpectedResultWithModifiedWikipediaExample()
        {
            ...
            List<Token> expected = [
                new Symbol("{"),
                new StringLiteral("first_name"),
                new Symbol(":"),
                new StringLiteral("John"),
                new Symbol(","),
                new StringLiteral("is_alive"),
                new Symbol(":"),
                new Sequence("true"),
                new Symbol(","),
                new StringLiteral("is_stupid"),
                new Symbol(":"),
                new Sequence("false"),
                new Symbol(","),
                ...
                new Symbol(":"),
                new Symbol("{"),
                new StringLiteral("city"),
                new Symbol(":"),
                new StringLiteral("New York"),
                new Symbol( ","),
                new StringLiteral("state"),
                new Symbol(":"),
                new StringLiteral("NY"),
                new Symbol(","),
                new StringLiteral("postal_code"),
                new Symbol(":"),
                new StringLiteral("645657z"),
                new Symbol("}"),
                new Symbol(","),
                new StringLiteral("phone_numbers"),
                new Symbol(":"),
                new Symbol("["),
                new Symbol("{"),
                ...
                new Symbol(":"),
                new StringLiteral("1337-001"),
                new Symbol("}"),
                new Symbol(","),
                new Symbol("{"),
                new StringLiteral("type"),
                new Symbol( ":"),
                new StringLiteral("office"),
                new Symbol(","),
                new StringLiteral("number"),
                new Symbol(":"),
                new Sequence("null"),
                ...
                new Symbol("]"),
                new Symbol(","),
                new StringLiteral("children"),
                new Symbol(":"),
                new Symbol("["),
                new StringLiteral("Catherine"),
                new Symbol(","),
                new StringLiteral("Thomas"),
                new Symbol(","),
                new StringLiteral("Trevor"),
                new Symbol("]"),
                new Symbol("}")
            ];
